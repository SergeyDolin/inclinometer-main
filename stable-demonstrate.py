...
Для компенсации температурного эффекта, который проявлялся как в движении пузырька уровня, так и в его изменении объема, были установлены два датчика температуры, для замера температуры колбы (синий) 
...
st.image('./img/TEST/all_temp.png')